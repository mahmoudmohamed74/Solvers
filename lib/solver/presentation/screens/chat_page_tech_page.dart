...
class TechChatPage extends StatelessWidget {
  final String? clientId;
  final String? clientName;
  final TextEditingController _messageController = TextEditingController();

  TechChatPage({Key? key, this.clientId, this.clientName}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final cubit = BlocProvider.of<TechCubit>(context)
      ..techGetMessages(clientId!);
    // final clientCubit = ClientCubit.get(context);
    return Scaffold(
      appBar: DefaultAppBar(
        appBarText: clientName!,
                      ...
                      return Expanded(
                        child: ListView.builder(
                          itemBuilder: (context, index) {
                            return Align(
                              alignment:
                                  state.message[index].senderId! == cubit.techId
